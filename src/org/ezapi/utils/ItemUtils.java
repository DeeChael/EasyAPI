...
public final class ItemUtils {
    ...
    public static void spawnItemWhoCanOnlySeeAndPickUp(ItemStack itemStack, Location location, Player player) {
    ...
    public static void spawnItemWhoCanOnlyPickUp(ItemStack itemStack, Location location, Player player) {
        Item item = location.getWorld().dropItem(location, itemStack);
        Object entityItem = Reflection_Class.getEntityItem(item);
        Reflection_Class.setOwner(entityItem, player);
    }

    public static void spawnItemWhoCanSeeAndWhoCanPickUp(ItemStack itemStack, Location location, Player whoCanPickUp, Player[] whoCanSee) {
        Item item = location.getWorld().dropItem(location, itemStack);
        Object entityItem = Reflection_Class.getEntityItem(item);
        int id = Reflection_Class.getId(entityItem);
